    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
            <div>
                ...
                <p class="text-xs text-slate-400 mt-1">Cek sisa stok barang terkini sebelum melakukan serah terima ke penerima.</p>
            </div>
            <div>
        ...
        <!-- Search Bar -->
        <div class="bg-slate-900/60 backdrop-blur border border-slate-800/80 rounded-2xl p-4 mb-8">
            <form action="" method="GET" class="flex flex-col sm:flex-row items-center gap-3">
                <div class="relative w-full sm:flex-1">
                    ...
                    <input type="text" name="q" value="<?= e($search) ?>" placeholder="Cari nama barang..."
                ...
                <?php if ($search !== ''): ?>
                    <a href="<?= base_url('public/katalog.php') ?>" class="w-full sm:w-auto px-4 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-slate-400 hover:text-white text-sm rounded-xl text-center transition">
                        Reset Filter
                    </a>
                <?php endif; ?>
            </form>
